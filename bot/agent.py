...
Grundlegend!!: Berechnungen und Counts müssen nicht in der Cyper-Query gemacht werden. Eine grundlegende Datenabfrage reicht aus. Sei dir bewusst, dass du lieber mehr daten mit in den nachfolgenden QA Schritt gibst, als zu wenig. Berechnungen und Counts werden im nächsten Schritt gemacht.
...
if __name__ == "__main__":
    print("FlightGPT ist bereit. Stellen Sie Ihre Fragen.")
    print("'exit' oder 'quit', um das Programm zu beenden.")
    
    while True:
        # Hier geben Sie Ihre Frage im Terminal ein
        user_input = input("\nIhre Frage: ")
        ...
        antwort = answer_question(user_input)
        print("\nAntwort vom System:", antwort)

# if __name__ == "__main__":
#     question = "Welche Airline ist mit einer A380 von Frankfurt nach New York geflogen?"
    
#     print(f"Received question: {question}")
#     antwort = answer_question(question)
